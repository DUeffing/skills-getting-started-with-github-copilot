...
activities = {
    ...
    "Drama Club": {
        "description": "Rehearse and perform plays, musicals, and improv theater",
    ...
    "Science Olympiad": {
        "description": "Prepare for and compete in science competitions across multiple disciplines",
